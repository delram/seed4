...
local function run(msg, matches)
  if matches[1]:lower() == 'hmd' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "hmd" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (hmd)",-- Put everything you like :)
		"^[!/]([Hh]md)",-- Put everything you like :)
    "^([Ss]tats)$",
    "^([Ss]tatslist)$",
    "^([Ss]tats) (group) (%d+)",
    "^([Ss]tats) (hmd)",-- Put everything you like :)
